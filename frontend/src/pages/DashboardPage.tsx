  ...
  return (
    <div>
      <PageHeader
        ...
        action={<Link className="inline-flex items-center gap-2 rounded-xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-800" to="/upload"><Plus className="size-4" /> New validation</Link>}
      />
