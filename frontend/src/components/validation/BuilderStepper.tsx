...
export function BuilderStepper({ steps, activeStep, onStepChange }: BuilderStepperProps) {
  ...
  return (
    <>
      ...
      <footer className="fixed bottom-0 right-0 left-[var(--app-sidebar-offset,0px)] z-40 border-t border-slate-200 bg-white/95 px-8 py-3 shadow-[0_-16px_40px_rgba(15,23,42,0.08)] backdrop-blur transition-[left] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]">
        <div className="mx-auto flex max-w-[1400px] flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="order-first min-w-0 text-center sm:order-none">
            <p className="text-xs font-medium uppercase tracking-[0.14em] text-slate-400">Current: {activeStepLabel}</p>
