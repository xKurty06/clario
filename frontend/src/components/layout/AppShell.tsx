          ...
          {collapsed ? (
            ...
            >
              <span className="relative grid size-8 place-items-center overflow-hidden rounded-[10px] bg-emerald-700 text-white transition-transform duration-200 group-hover:scale-105 group-active:scale-95">
                <span className="text-xs font-bold transition-all duration-200 group-hover:-translate-x-2 group-hover:opacity-0 group-focus-visible:-translate-x-2 group-focus-visible:opacity-0">PV</span>
